              ...
              <div className={styles.offerRow}>
                <div className={styles.tabContent}>
                  ...
                  <p>
                    ...
                    will communicate closely with you to define the project
                    vision and scope. We undertake user research, prototype and
                    test ideas, and validate tech feasibility to create a user —
            ...
            <>
              <div className={styles.offerRow}>
                <div className={styles.tabContent}>
                  <h3>UX/UI Design</h3>
                  <p>
                    During the UX/UI stage, our designers the UX and UI design
                    for mobile and web apps. Using mood boarding and preparing
                    several UI concepts, we make sure the visual design of the
                    future product.
                  </p>
                </div>
                <div className={styles.offersInfo}>
            ...
            <>
              <div className={styles.offerRow}>
                <div className={styles.tabContent}>
                  ...
                  <p>
                    Innovative designand intutive functionality implemented by
                    our frontend and backend team result in attracive welsites.
                    We set up reliable, secure, efficient and scalable server
                    areitecture so that our websites work well, whether it
                    caters for on more than 100 000 users.
                  </p>
                </div>
                <div className={styles.offersInfo}>
                  <div className={styles.offersOther}>
